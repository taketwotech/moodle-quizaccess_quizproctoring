...
$string['warning_threshold_help'] = "Nombre d'avertissements que l'utilisateur doit recevoir avant d'être disqualifié de l'examen surveillé.";
...
$string['quizproctoring:quizproctoringreport'] = 'Rapport d\'utilisateur de surveillance de quiz';

...
$string['disableeyetrackingallquizzes'] = 'Disable eye tracking for all quizzes of this user';
$string['disableeyetrackingmessage'] = 'Do you want to disable eye tracking for user {$a}?';
...
$string['enableeyetrackingmessage'] = 'Do you want to enable eye tracking for user {$a}?';
...
$string['teachersubmitted'] = 'Teacher Submitted';
$string['teachersubmitted_help'] = 'Indicates whether the quiz was submitted by a teacher.';

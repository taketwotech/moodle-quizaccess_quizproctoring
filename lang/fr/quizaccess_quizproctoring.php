...
$string['proctoringaccessrestricted'] = 'L\'accès à la surveillance sur ce site est restreint. Pour obtenir de l\'aide, envoyez un e-mail au <a href="mailto:support@proctorlink.com">support ProctorLink</a>.';
...
$string['yespendingimage_note'] = 'Les images en attente sont des captures qui n\'ont pas pu être analysées par le service de détection faciale au moment de leur enregistrement (par exemple, en raison d\'une interruption temporaire du service). Elles sont surlignées en orange jusqu\'à leur retraitement.';

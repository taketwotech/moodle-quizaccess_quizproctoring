...
$string['enablestrictcheck'] = 'Enable strict check during exam';
$string['enablestrictcheck_help'] = 'When enabled, the system monitors and throws a warning if students turn their heads, look left or right, or close their eyes for more than 2 seconds during the exam.';
$string['enablestricteyecheck'] = 'Eye Tracking Detection';
$string['enablestricteyecheck_help'] = 'When enabled, the system monitors and throws a warning if students eye is close or face down during image capture during the exam.';
$string['enablestudentvideo'] = 'Enable student video during exam';
$string['enablestudentvideo_help'] = 'If you enable it, Student should be able to see his/her video during exam.';
...
$string['nostudentonline'] = 'No student is online';

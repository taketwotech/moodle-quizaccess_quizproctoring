...
$string['nocameradetected'] = 'La caméra ou le microphone sont désactivés. Veuillez les activer tous les deux pour continuer. {$a}';
$string['nocameradetectedm'] = 'La caméra ou le microphone sont désactivés. Veuillez les activer tous les deux pour continuer.';
...
$string['tabwarningoneleft'] = 'Ne quittez pas l\'onglet actif. Il ne vous reste plus qu\'un avertissement.';

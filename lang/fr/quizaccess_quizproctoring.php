...
$string['actionas'] = 'Supprimer les audios';
$string['actionas_help'] = 'Supprimer définitivement tous les audios associés à la tentative de cet utilisateur.';
$string['actions'] = 'Supprimer les images';
$string['actions_help'] = 'Supprimer définitivement toutes les images associées à la tentative de cet utilisateur.';
$string['activeplan'] = 'Plan actif :';
$string['alerts'] = 'Remarques de l\'enseignant';
$string['alerts_help'] = 'Alertes de surveillance envoyées pendant cette tentative de quiz.';
...
$string['audionotsupported'] = 'Votre navigateur ne prend pas en charge l\'élément audio.';
$string['audiosdeleted'] = 'Audios supprimés avec succès';
$string['autosubmit'] = 'Le seuil d\'avertissement a été atteint. Votre quiz a été automatiquement soumis.';
$string['autosubmitbyteacher'] = 'Votre questionnaire a été soumis.';
$string['buycredit'] = 'Acheter des crédits';
...
$string['creditbalanceupdatenote'] = 'Note : Le solde de crédit est mis à jour toutes les 12 heures, votre dernière utilisation peut donc être reflétée avec un délai.';
$string['creditbaseplan'] = 'À base de crédit';
$string['credits'] = 'Crédits restants :';
$string['creditsleft'] = 'Crédits restants :';
$string['creditsremaining'] = 'Crédits restants :';
$string['csvheader_multiface'] = 'Plusieurs visages';
$string['csvheader_nocamera'] = 'Pas de caméra';
$string['csvheader_noeye'] = 'Pas d\'œil';
$string['csvheader_noface'] = 'Pas de visage';
$string['csvheader_photoslink'] = 'Lien photos';
$string['csvheader_starttime'] = 'Heure de début';
$string['csvheader_student'] = 'Étudiant';
$string['csvheader_tabswitch'] = 'Changement d\'onglet';
$string['csvheader_totalwarnings'] = 'Avertissements totaux';
$string['delcourseaudios'] = 'Supprimer tous les audios stockés de {$a}';
$string['delcoursemages'] = 'Supprimer toutes les images stockées de {$a}';
$string['deleteallaudios'] = 'Je comprends que ces audios seront définitivement supprimés et ne pourront pas être récupérés.';
$string['deleteallaudioscourse'] = 'Voulez-vous supprimer tous les audios associés au cours "{$a}" ? Veuillez noter que cette action est permanente et irréversible.<br/><br/>';
$string['deleteallaudiosquiz'] = 'Voulez-vous supprimer tous les audios associés au quiz "{$a}" ? Veuillez noter que cette action est permanente et irréversible.<br/><br/>';
$string['deleteallaudiosuser'] = 'Voulez-vous supprimer tous les audios associés à "{$a}" ? Veuillez noter que cette action est permanente et irréversible.<br/><br/>';
...
$string['disableeyetrackingmessage_global'] = 'Le suivi oculaire est déjà désactivé globalement pour l\'utilisateur {$a}. Voulez-vous le garder désactivé pour tous les quiz?';
...
$string['enablerecordaudio'] = 'Activer l\'enregistrement audio';
...
$string['exportcsv_generating'] = 'Génération du CSV...';
$string['exportpdf'] = 'Exporter le rapport en PDF';
$string['exportpdf_generating'] = 'Génération du PDF...';
...
$string['eyeoff'] = 'Désactiver le suivi oculaire';
$string['eyeofferror'] = 'Erreur lors de la désactivation du suivi oculaire';
$string['eyeon'] = 'Activer le suivi oculaire';
...
$string['grades'] = 'Notes';
$string['grades_help'] = 'La note ou les points obtenus pour cette tentative de quiz.';
...
$string['iseyedisabledbyteacher'] = 'Désactivé par l\'enseignant';
$string['iseyedisabledbyteacher_help'] = 'Indique si le suivi oculaire a été désactivé par un enseignant pour cette tentative. "Oui" signifie que l\'enseignant a désactivé manuellement le suivi oculaire.';
$string['iseyeoff'] = 'Suivi oculaire';
...
$string['pdf_multiface'] = 'Plusieurs visages';
$string['pdf_nocamera'] = 'Pas de caméra';
$string['pdf_noeye'] = 'Pas d\'œil';
$string['pdf_noface'] = 'Pas de visage';
$string['pdf_photos'] = 'Photos';
$string['pdf_student'] = 'Étudiant';
$string['pdf_tabswitch'] = 'Changement d\'onglet';
$string['pdf_time'] = 'Heure';
$string['pdf_title'] = 'Analyse faciale pour tous les étudiants';
$string['pdf_total'] = 'Total';
$string['pdf_view'] = 'voir';
$string['pendingprocessing'] = 'Traitement en attente';
$string['planadvanced'] = 'Avancé';
$string['planfree'] = 'Gratuit';
$string['planstarter'] = 'Démarrage';
$string['plansyncfailed'] = 'Impossible d\'actualiser les détails du plan depuis ProctorLink. Les informations les plus récentes sont affichées.';
$string['plansyncsuccess'] = 'Les détails du plan ont été actualisés avec succès.';
...
$string['proctoringaudio'] = 'Audio de surveillance';
$string['proctoringaudio_help'] = 'Audio capturé pendant la session de surveillance pour surveiller l\'activité de l\'utilisateur.';
...
$string['proctoringaccessrestricted'] = 'L\'accès à la surveillance sur ce site est restreint.';
...
$string['purchaseplan'] = 'Acheter un plan';
...
$string['refreshplan'] = 'Actualiser maintenant';
...
$string['reprocessimages_note'] = 'Certaines images n\'ont pas pu être analysées lors de leur capture en raison d\'une interruption temporaire du service. Cliquez sur Retraiter les images pour les analyser à nouveau.';
$string['reprocessimages_processing'] = 'Retraitement en cours...';
$string['reprocessimages_processing_remaining'] = 'Retraitement en cours... ({$a} restantes)';
$string['reprocessresult'] = 'Retraitement terminé. {$a->processed} image(s) traitée(s), {$a->pending} toujours en attente, {$a->failed} échouée(s). {$a->remaining} image(s) restent à retraiter.';
...
$string['splitscreendetected'] = 'L\'affichage en écran partagé n\'est pas autorisé pendant ce quiz. Veuillez maximiser votre fenêtre de navigateur. {$a}';
...
$string['teachersubmitted'] = 'Terminé par l\'enseignant';
$string['teachersubmitted_help'] = 'Indique si le quiz a été terminé par un enseignant.';
...
$string['totalcredits'] = 'Total des crédits :';
$string['twentyseconds'] = '20 secondes';
$string['twominutes'] = '2 minutes';
$string['updatenote'] = 'Note : Les détails du plan peuvent prendre jusqu\'à 24 heures pour se mettre à jour après le renouvellement ou la mise à niveau.';
$string['upgradeplan'] = 'Mettre à niveau le plan';
...
$string['userreport_attemptid'] = 'ID de tentative';
$string['userreport_attempttime'] = 'Heure de tentative';
$string['userreport_studentname'] = 'Nom de l\'étudiant';
$string['userreport_title'] = 'Analyse faciale de l\'étudiant pour {$a}';
...
$string['verificationunavailable'] = 'La vérification est temporairement indisponible en raison d\'un problème réseau temporaire. Veuillez réessayer sous peu.';
$string['viewallimages_checkbox'] = 'Pour voir toutes les images enregistrées du quiz, veuillez cocher la case.';
$string['viewaudio'] = 'Voir l\'audio';
...
$string['yespendingimage_label'] = 'Image en attente';
$string['yespendingimage_note'] = 'Les images en attente n\'ont pas pu être analysées par le service d\'IA lors de leur capture, généralement en raison d\'un problème temporaire du service. Elles sont surlignées en orange jusqu\'à leur retraitement.';

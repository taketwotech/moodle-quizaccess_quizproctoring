...
$string['proctoringvideo'] = 'Proctoring Video';
...
$string['endpoint'] = 'Facematch End Point';
$string['endpoint_help'] = 'Enter Facematch End Point here to be used for Proctoring services';
$string['accesstoken'] = 'Extenal Server Access Token';

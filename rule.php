...
class quizaccess_quizproctoring extends quizaccess_quizproctoring_rule_base {
    ...
    public static function add_settings_form_fields(mod_quiz_mod_form $quizform, MoodleQuickForm $mform) {
        ...
        // Refresh plan details on demand when stale (throttled).
        ...
        $refreshurl = $cmid > 0 ? quizaccess_quizproctoring_plan_refresh_url($cmid) : null;
        $planstatus = quizaccess_quizproctoring_render_plan_status($refreshurl);

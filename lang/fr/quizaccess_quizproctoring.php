...
$string['endpoint'] = 'Service pour faire correspondre les visages';
$string['endpoint_help'] = 'Entrez ici le point de terminaison Facematch à utiliser pour les services de surveillance';

...
$string['proctoringaccessrestricted'] = 'Proctoring access on this site is restricted. For help, email <a href="mailto:support@proctorlink.com">ProctorLink support</a>.';
...
$string['yespendingimage_note'] = 'Pending images are snapshots that could not be analyzed by the face detection service when they were captured (for example, due to a temporary service outage). They are highlighted in orange until they are reprocessed.';

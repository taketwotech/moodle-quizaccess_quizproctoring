...
$string['creditsleft'] = 'Credits Remaining:';
...
$string['enableteacherproctor'] = 'Live proctoring';
...
$string['proctoringaccessrestricted'] = 'Proctoring access on this site is restricted.';
...
$string['refreshplan'] = 'Refresh now';
...
$string['reprocessimages_note'] = 'Some images could not be analyzed when they were captured due to a temporary service outage. Click Reprocess Images to analyze them again.';
...
$string['splitscreendetected'] = 'Split-screen view is not allowed during this quiz. Please maximize your browser window. {$a}';
...
$string['yespendingimage_note'] = 'Pending images could not be analyzed by the AI service when they were captured, typically due to a temporary service issue. They are highlighted in orange until reprocessed.';

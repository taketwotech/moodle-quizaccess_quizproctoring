...
$string['creditbalanceupdatenote'] = 'Note : Le solde de crédit est actualisé automatiquement à l\'ouverture de cette page. Utilisez Actualiser le plan pour mettre à jour immédiatement.';
...
$string['plansyncfailed'] = 'Impossible d\'actualiser les détails du plan depuis ProctorLink. Affichage des informations les plus récemment synchronisées.';
$string['plansyncinterval'] = 'Intervalle de synchronisation du plan';
$string['plansyncinterval_help'] = 'Délai minimum entre les synchronisations automatiques du plan lorsque les administrateurs ouvrent les pages de paramètres ProctorLink. Utilisez Actualiser le plan pour une mise à jour immédiate.';
$string['sixhours'] = '6 heures';
$string['twelvehours'] = '12 heures';
$string['twentyfourhours'] = '24 heures';
$string['plansynclastsynced'] = 'Dernière synchronisation : {$a}';
$string['plansyncsuccess'] = 'Détails du plan actualisés avec succès.';
$string['planstatusheading'] = 'Statut du plan ProctorLink';
$string['refreshplan'] = 'Actualiser le plan';
$string['sixtyminutes'] = '60 minutes';
$string['thirtyminutes'] = '30 minutes';
$string['updatenote'] = 'Note : Les détails du plan s\'actualisent automatiquement à l\'ouverture de cette page. Utilisez Actualiser le plan après un renouvellement ou une mise à niveau.';

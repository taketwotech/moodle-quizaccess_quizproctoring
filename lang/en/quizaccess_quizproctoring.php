...
$string['deleteallimagescourse'] = ' Do you want to delete all images for "{$a}" course?';
$string['deleteallimagesuser'] = 'Do you want to delete the images for "{$a}"?';
$string['deleteallimagesquiz'] = 'Do you want to delete all images for "{$a}" quiz?';

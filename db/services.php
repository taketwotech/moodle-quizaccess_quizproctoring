 ...
 * @package    mod_quiz
 */
require_once($CFG->dirroot . '/mod/quiz/accessrule/quizproctoring/locallib.php');

$functions = array(
    'quizaccess_quizproctoring_save_video_recording' => array(
        'classname'     => 'quizaccess_quizproctoring_external',
        'methodname'    => 'save_video_recording',
...
$services = array(
    'Proctoring web service'  => array(
        'functions' => array (
            'quizaccess_quizproctoring_save_video_recording',

...
$string['actionas'] = 'Delete Audios';
$string['actionas_help'] = 'Permanently remove all audios associated with this user\'s attempt.';
$string['actions'] = 'Delete Images';
$string['actions_help'] = 'Permanently remove all images associated with this user\'s attempt.';
$string['activeplan'] = 'Active Plan:';
$string['alerts'] = 'Teacher Remarks';
$string['alerts_help'] = 'Proctoring alerts sent during this quiz attempt.';
$string['allimages'] = 'All Images';
$string['attempts'] = 'Attempt';
$string['attemptslast'] = 'Last Attempt';
$string['attemptstarted'] = 'Attempt started:';
$string['audionotsupported'] = 'Your browser does not support the audio element.';
$string['audiosdeleted'] = 'Audios Deleted Successfully';
...
$string['creditbalanceupdatenote'] = 'Note: Credit balance is refreshed automatically when you open this page. Use Refresh plan to update immediately.';
...
$string['delcourseaudios'] = 'Delete all stored audios of {$a}';
$string['delcoursemages'] = 'Delete all stored images of {$a}';
$string['deleteallaudios'] = 'I understand that these audios will be permanently deleted and cannot be recovered.';
$string['deleteallaudioscourse'] = 'Do you want to delete all audios associated with "{$a}" course? Please be aware that this action is permanent and cannot be undone.<br/><br/>';
$string['deleteallaudiosquiz'] = 'Do you want to delete all audios associated with "{$a}" quiz? Please be aware that this action is permanent and cannot be undone.<br/><br/>';
$string['deleteallaudiosuser'] = 'Do you want to delete all audios associated with "{$a}"? Please be aware that this action is permanent and cannot be undone.<br/><br/>';
...
$string['enablerecordaudio'] = 'Enable audio recording';
$string['enablerecordaudio_help'] = 'Allow the system to record audio during quiz attempts for proctoring purposes.';
...
$string['pendingprocessing'] = 'Pending processing';
...
$string['verificationunavailable'] = 'Verification is temporarily unavailable due to a temporary network issue. Please try again shortly.';
...
$string['proctoringaudio'] = 'Proctoring Audio';
$string['proctoringaudio_help'] = 'Audio captured during the proctoring session for monitoring user activity.';
...
$string['plansyncfailed'] = 'Could not refresh plan details from ProctorLink. Showing the most recently synced information.';
$string['plansyncinterval'] = 'Plan sync interval';
$string['plansyncinterval_help'] = 'Minimum time between automatic plan synchronizations when administrators open ProctorLink settings pages. Use Refresh plan for an immediate update.';
$string['sixhours'] = '6 hours';
$string['twelvehours'] = '12 hours';
$string['twentyfourhours'] = '24 hours';
$string['plansynclastsynced'] = 'Last synced: {$a}';
$string['plansyncsuccess'] = 'Plan details refreshed successfully.';
$string['planstatusheading'] = 'ProctorLink plan status';
$string['refreshplan'] = 'Refresh plan';
$string['sixtyminutes'] = '60 minutes';
$string['updatenote'] = 'Note: Plan details refresh automatically when you open this page. Use Refresh plan after renewal or upgrade.';
...
$string['yespendingimage_label'] = 'Pending image';
